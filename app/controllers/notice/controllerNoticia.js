...
// buscar noticia por titulo del documento
...
exports.setNoticia = function (req, res) {
    ...
    Noticia.create(
        ...
        function (err, noticia) {
            ...
            Noticia.find(function (err, noticias_) {
                if (err)
                    res.send(err);
...
exports.updateNoticia = function (req, res) {
    Noticia.update({_id: req.body._id},
        {
            $set: {
                titulo: req.body.titulo,
                resumen: req.body.resumen,
