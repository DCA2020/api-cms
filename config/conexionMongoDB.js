...
mongoose.connect(db, options)
    .then(function () {
        console.log('La conexión con el servidor MongoDB se ha establecido exitosamente!');
    }).catch(function (err) {
        console.log('No se ha podido establecer la conexión con el servidor MongoDB!');
